...
#本机的IP地址
export LOCALHOST_IP="192.168.123.181"
...
### 定时任务地址,目前只启动一个进程，ip
export cron_domain="192.168.123.181"
...
# 写数据库
export DEFAULT_DB_DBHOST="192.168.123.181"
...
# 读数据库
export READONLY_DB_DBHOST='192.168.123.181'
...
# 消息队列
export DEFAULT_MQ_ADDR='192.168.123.181'
export DEFAULT_MQ_USER=${MQ_USER}
export DEFAULT_MQ_PWD=${MQ_PASSWORD}

# 缓存
export DEFAULT_REDIS_HOST='192.168.123.181'
