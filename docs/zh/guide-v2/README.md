...
- [flow - 编排自动化工作流](./5-codo-flow/README.md) 
  - [安装 codo-agent](./5-codo-flow/codo-agent.md) 
  - [案例 - 使用 codo-flow 实现 golang 应用自动化CI/CD](./5-codo-flow/example-cicd.md) 
  - [案例 - 使用 codo-flow + cmdb 实现 跨地区应用部署](./5-codo-flow/example-distribute-deploy.md) 
  - [案例 - 使用 codo-flow + notice 实现 高效流程审批](./5-codo-flow/example-flow-audit.md)
